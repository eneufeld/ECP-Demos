...
/**
 * This is the item provider adapter for a {@link com.eclipsesource.accounting.Deliverable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeliverableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Deliverable_dueDate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Deliverable_dueDate_feature", "_UI_Deliverable_type"),
				 AccountingPackage.Literals.DELIVERABLE__DUE_DATE,
				 true,
				 false,
				 false,
	...
	protected void addUnitAmountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Deliverable_unitAmount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Deliverable_unitAmount_feature", "_UI_Deliverable_type"),
				 AccountingPackage.Literals.DELIVERABLE__UNIT_AMOUNT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Date labelValue = ((Deliverable)object).getDueDate();
