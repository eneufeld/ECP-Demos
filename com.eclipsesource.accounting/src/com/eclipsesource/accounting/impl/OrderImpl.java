 ...
 * <ul>
 *   <li>{@link com.eclipsesource.accounting.impl.OrderImpl#getId <em>Id</em>}</li>
 *   <li>{@link com.eclipsesource.accounting.impl.OrderImpl#getProject <em>Project</em>}</li>
 *   <li>{@link com.eclipsesource.accounting.impl.OrderImpl#getDeliverables <em>Deliverables</em>}</li>
 *   <li>{@link com.eclipsesource.accounting.impl.OrderImpl#getInvoices <em>Invoices</em>}</li>
 *   <li>{@link com.eclipsesource.accounting.impl.OrderImpl#getPaymentOffset <em>Payment Offset</em>}</li>
 *   <li>{@link com.eclipsesource.accounting.impl.OrderImpl#getPricePerUnit <em>Price Per Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderImpl extends EObjectImpl implements Order {
	...
	public boolean validateUnitAmount(DiagnosticChain diagnosticChain, Map<Object, Object> context) {
		...
		EReference blameReference;
		if (numAmountDeliverable < numAmountInvoice) {
			blameReference = AccountingPackage.eINSTANCE
					.getOrder_Deliverables();
		...
		if (diagnosticChain != null) {
			diagnosticChain.add(new BasicDiagnostic(Diagnostic.ERROR,
					AccountingValidator.DIAGNOSTIC_SOURCE,
					AccountingValidator.ORDER__VALIDATE_UNIT_AMOUNT,"Invoice unit amount ("+numAmountInvoice+") and Delivarables unit amount ("+numAmountDeliverable+") do not match.", new Object[] { this,
							blameReference }));
		}
		return false;
	}
