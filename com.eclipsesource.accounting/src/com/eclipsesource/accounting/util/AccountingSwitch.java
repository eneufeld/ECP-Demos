...
public class AccountingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AccountingPackage.CLIENT_DATABASE: {
				ClientDatabase clientDatabase = (ClientDatabase)theEObject;
				T result = caseClientDatabase(clientDatabase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AccountingPackage.EMPLOYEE_DATABASE: {
				EmployeeDatabase employeeDatabase = (EmployeeDatabase)theEObject;
				T result = caseEmployeeDatabase(employeeDatabase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Client Database</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Client Database</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseClientDatabase(ClientDatabase object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Employee Database</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Employee Database</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEmployeeDatabase(EmployeeDatabase object) {
		return null;
	}
